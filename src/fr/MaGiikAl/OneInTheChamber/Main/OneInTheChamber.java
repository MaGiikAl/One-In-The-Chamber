...
import fr.MaGiikAl.OneInTheChamber.Events.PlayerCommandPreprocess;
...
public class OneInTheChamber extends JavaPlugin{
	...
	public void loadConfiguration(){
		...
		if(!fichier_language.exists()){
			...
			Language.addDefault("Language.Help.Setup.Lives", "  &4>>>>>  &9&l/oitc setlives <arena> &bto set the lives of an arena");
			Language.addDefault("Language.Help.Setup.Countdown", "  &4>>>>>  &9&l/oitc setcountdown <arena> &bto set the countdown of an arena");
